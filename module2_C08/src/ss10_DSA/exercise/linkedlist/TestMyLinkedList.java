...
//        MyLinkedList<IStudent> cloneLinkedList = myLinkedList.clone();
//
//        for (int i = 0; i < cloneLinkedList.size(); i++) {
//            IStudent review.student = (IStudent) cloneLinkedList.get(i);
//            System.out.println(review.student.getName());
//        }
